...
\todo[inline]{LF Ausgangssync mit FB}
...
\end{equation}
\todo[inline]{nicht-aggregierte form}

Eingesetzt und aggregiert ergibt das folgende Dynamik für das geregelte MAS und das kooperative
interne Modell:
\begin{align}
